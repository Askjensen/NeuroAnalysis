...
prep_and_save_hist(anova_hist_median,'anova_leneveT_median','levene teststatistic using median for ANOVA per timebin')
prep_and_save_hist(anova_pval_hist_median,'anova_pval_hist_median','levene p-value using median for ANOVA per timebin')
prep_and_save_hist(anova_hist_mean,'anova_hist_mean','levene teststatistic using median for ANOVA per timebin')
prep_and_save_hist(anova_pval_hist_mean,'anova_pval_hist_mean','levene p-value using median for ANOVA per timebin')
